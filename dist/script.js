...
function accordion() {
  document.querySelectorAll('.accordion__item-label').forEach(function (trigger) {
...
function range() {
  ...
  var sliderColor = '#C4C7C7';
  var rangeColor = '#8E9192'; // Offset prevent slides from collapsing

  var sldiersOffset = 6;
  var minValue = parseInt(fromInput.min, 10);
  var maxValue = parseInt(fromInput.max, 10);
  var factor = Math.ceil((maxValue - minValue) / 100);
  ...
  function getRefactoredValue(value) {
    var reduce = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  ...
  function fillSlider() {
    var rangeDistance = toSlider.max - toSlider.min;
    var fromPosition = fromSlider.value - toSlider.min;
    var toPosition = toSlider.value - toSlider.min;
  ...
  fromInput.onchange = function () {
    return controlFromInput(fromSlider, fromInput, toInput);
  };

  toInput.onchange = function () {
    return controlToInput(toSlider, fromInput, toInput);
  };
}
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  (0,_modules_range__WEBPACK_IMPORTED_MODULE_1__["default"])();
});
})();
